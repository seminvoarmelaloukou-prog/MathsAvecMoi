...
// Garde la session connectée même après fermeture du navigateur
// (comportement par défaut, mais rendu explicite pour éviter toute déconnexion inattendue)
auth.setPersistence(firebase.auth.Auth.Persistence.LOCAL).catch(function(erreur) {
  console.warn("Impossible de définir la persistance de session :", erreur);
});
